...
--
-- Name: types types_pk; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--
...
--
-- Name: properties f; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT f FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
